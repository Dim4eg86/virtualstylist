...
async def start(message: types.Message):
    ...
    welcome_text = (
        ...
        "🎯 <b>Что я умею:</b>\n"
        "• Примеряю одежду по фото за 7-30 секунд\n"
        "• Использую лучшие AI-технологии 2026 года\n"
        "• Создаю реалистичные примерки с сохранением деталей\n\n"
        "👕 <b>Категории одежды:</b>\n"
        "• <b>Верх</b>: рубашки, блузки, свитера, топы (50₽)\n"
        "• <b>Низ</b>: брюки, юбки, шорты (50₽)\n"
        "• <b>Платье</b>: цельные платья ⚡ FASHN v1.5 (80₽)\n\n"
        "💡 <i>Просто загрузи своё фото и фото одежды!</i>\n\n"
...
async def set_cat(callback: types.CallbackQuery, state: FSMContext):
    ...
    if key == "dresses":
        message_text = (
            "👗 <b>Примерка платья</b>\n\n"
            "✨ <b>Используется FASHN v1.5 - новейшая AI-модель 2026 года!</b>\n\n"
            "⚡ Генерация за ~7 секунд\n"
            "🎯 Цельное платье с сохранением деталей\n\n"
            "💰 <b>Стоимость: 80₽</b>\n\n"
            "📷 <b>Отправь фото платья</b>\n\n"
            "💡 <b>ВАЖНО для лучшего результата:</b>\n"
            "• Твоё фото должно быть <b>в платье или сарафане</b>\n"
            "• AI заменит платье на новое\n"
            "• Фото одежды на белом фоне или манекене\n"
            "• Полный рост для лучшего результата\n\n"
            "⚠️ <i>Если на фото брюки - AI может изменить их цвет</i>"
        )
    else:
        message_text = (
